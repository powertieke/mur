...
syncloops = {"clients": ["pi1", "pi2", "pi3", "pi4", "pi5", "pi6", "pi7", "pi8"], "moviefile" : "paris", "repeats": 10, "intervalmoviefile" : "paris"}
...
def main():
	...
	if args.slave :
		...
		bgImage = subprocess.Popen(["/usr/bin/python", "imageblitter.py", args.moviepath], stdin=subprocess.PIPE)
